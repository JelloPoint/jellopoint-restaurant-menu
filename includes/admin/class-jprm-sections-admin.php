<?php
/**
 * Sections Admin (term-meta UI)
 *
 * Adds a simple dropdown on the jprm_section taxonomy add/edit screens
 * to link a Section to its owning Menu via term meta `_jprm_menu_id` (integer).
 *
 * This is used by the Elementor editor AJAX endpoint to filter the Sections
 * control by the selected Menu.
 */
...
final class JPRM_Sections_Admin {
