...
class JPRM_Admin_MenuItem_Meta {
    ...
    public static function enqueue(){
        ...
        // Remove any legacy/conflicting admin scripts if present
    ...
    public static function register_metaboxes(){
        // Remove legacy metabox if present
    ...
    public static function render_pricing($post){
        ...
        echo '<style>
            ...
            /* TABLE: hard column locks so rows align with header, no overlap */
            ...
            #jprm2-prices-table th:nth-child(3),#jprm2-prices-table td:nth-child(3){width:120px}
            ...
            /* Label cell may not spill into Amount column */
            #jprm2-prices-table td.label-td{overflow:hidden!important;position:relative;min-width:0}
            ...
            .label-td .inline-field{display:inline-flex;gap:8px;align-items:center;flex:1 1 auto;min-width:0;max-width:calc(100% - 140px);overflow:hidden}
            .label-td .inline-field select.label-ref{max-width:150px;flex:0 0 auto}
            .label-td .inline-field input.label-custom{width:120px;max-width:140px;flex:0 0 auto}

            /* Amount input stays visible */
            #jprm2-prices-table input.amount{width:7.5em!important}
...
(function($){
  ...
  $('#jprm2-row-add').off('click').on('click'+NS,function(e){
    ...
    setRowMode($tr,'ref'); // ensures correct visibility & data-mode
    collect();
  });
