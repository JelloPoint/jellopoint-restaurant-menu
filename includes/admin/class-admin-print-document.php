...
/** Phase 11A settings screen; rendering and downloads follow in 11B/11C. */
final class Print_Document_Admin {
	...
	public static function render() : void {
		...
		<div class="wrap jprm-print-settings">
			...
			<p><?php esc_html_e( 'Choose the source Menu and paper settings. Printable designs and PDF downloads will be added in the next phases.', 'jellopoint-restaurant-menu' ); ?></p>
			...
			<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
				...
				<?php submit_button( __( 'Save Print Settings', 'jellopoint-restaurant-menu' ) ); ?>
			</form>
