...
foreach ( $overrides as $ov ) {
    ...
    if ( $layout === 'inline_below' && $separator !== '' ) {
		...
		$ctx = [
			...
			'show_main_sections'      => ( isset($settings['show_main_sections']) && $settings['show_main_sections'] === 'yes' ) ? 'yes' : 'no',
			'show_main_even_if_empty' => ( isset($settings['show_main_even_if_empty']) && $settings['show_main_even_if_empty'] === 'yes' ) ? 'yes' : 'no',
