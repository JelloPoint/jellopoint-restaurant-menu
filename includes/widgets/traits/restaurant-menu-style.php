...
trait Restaurant_Menu_Style {
	...
	/**
	 * Register all STYLE tab controls (Elementor best-practice, global-aware).
	 * Call this at the end of register_controls() in the widget class.
	 */
	protected function register_style_controls() : void {
		...
		$this->add_control( 'section_title_color', [
			...
			'selectors' => [
				'{{WRAPPER}} .jp-section__title' => 'color: {{VALUE}};',
			],
		] );
		...
		$this->add_control( 'section_desc_color', [
			...
			'global'  => [ 'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Colors::COLOR_TEXT ],
			'selectors' => [
				'{{WRAPPER}} .jp-section__desc' => 'color: {{VALUE}};',
			],
		] );
		...
		$this->add_control( 'item_desc_color', [
			...
			'global'  => [ 'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Colors::COLOR_TEXT ],
			'selectors' => [
				'{{WRAPPER}} .jp-menu__desc, {{WRAPPER}} .jp-matrix__desc' => 'color: {{VALUE}};',
			],
		] );
		...
		$this->add_control( 'price_value_color', [
			...
			'selectors' => [
				'{{WRAPPER}} .jp-menu__value, {{WRAPPER}} .jp-matrix__cell--value' => 'color: {{VALUE}};',
			],
		] );
		...
		$this->add_responsive_control( 'price_align', [
			...
			'default'   => 'left',
			'selectors' => [
				'{{WRAPPER}} .jp-menu__pricegroup' => 'text-align: {{VALUE}};',
			],
		] );
		...
		$this->add_control( 'label_text_color', [
			...
			'global'  => [ 'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Colors::COLOR_TEXT ],
			'selectors' => [
				'{{WRAPPER}} .jp-col-label, {{WRAPPER}} .jp-lhdr-text' => 'color: {{VALUE}};',
			],
		] );
		...
		$this->add_group_control(
			...
			[
				'name'     => 'badges_typo',
				'global'   => [ 'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Typography::TYPOGRAPHY_TEXT ],
				'selector' => '{{WRAPPER}} .jp-menu__titleline .jp-badge',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'global'   => [ 'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Typography::TYPOGRAPHY_SECONDARY ],
				'selector' => '{{WRAPPER}} .jprm-infoblock__title',
			]
		);
		$this->add_control( 'infob_title_color', [
			'label'   => __( 'Title Color', 'jellopoint-restaurant-menu' ),
			'type'    => \Elementor\Controls_Manager::COLOR,
			'global'  => [ 'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Colors::COLOR_SECONDARY ],
			'selectors' => [
				'{{WRAPPER}} .jprm-infoblock__title' => 'color: {{VALUE}};',
			],
		] );
		...
		$this->add_control( 'infob_body_color', [
			...
			'global'  => [ 'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Colors::COLOR_TEXT ],
			'selectors' => [
				'{{WRAPPER}} .jprm-infoblock__content' => 'color: {{VALUE}};',
			],
		] );
		...
		$this->add_responsive_control( 'infob_image_size', [
			...
			'default'   => [ 'size' => 80 ],
			'selectors' => [
				'{{WRAPPER}} .jprm-infoblock__image img' => 'width: {{SIZE}}{{UNIT}}; height: auto;',
			],
		] );
		...
		$this->add_control( 'matrix_title_min_width', [
			...
			'selectors'   => [
				'{{WRAPPER}} .jp-matrix' => '--jp-mx-title-min: {{SIZE}}{{UNIT}};',
			],
		] );
		...
		$this->add_control( 'matrix_col_gap', [
			...
			'default'     => [ 'size' => 0 ],
			'selectors'   => [
				'{{WRAPPER}} .jp-matrix' => '--jp-mx-col-gap: {{SIZE}}{{UNIT}};',
			],
		] );
		...
		$this->add_control( 'matrix_row_gap', [
			...
			'default'     => [ 'size' => 0 ],
			'selectors'   => [
				'{{WRAPPER}} .jp-matrix' => '--jp-mx-row-gap: {{SIZE}}{{UNIT}};',
			],
		] );
		...
		$this->add_control( 'matrix_value_align', [
			...
			'selectors' => [
				'{{WRAPPER}} .jp-matrix' => '--jp-mx-text-align: {{VALUE}};',
			],
		] );
