...
$this->add_control( 'items_order_overrides', [
    ...
    'description' => __(
		...
		$this->add_control( 'daily_menu_price_position', [
			'label'   => __( 'Daily Menu price position', 'jellopoint-restaurant-menu' ),
			'type'    => Controls_Manager::SELECT,
			'default' => 'beside_date',
			'options' => [
				'beside_date' => __( 'Beside Date', 'jellopoint-restaurant-menu' ),
				'below_date'  => __( 'Below Date', 'jellopoint-restaurant-menu' ),
				'bottom_menu' => __( 'Bottom of Daily Menu', 'jellopoint-restaurant-menu' ),
			],
...
$this->end_controls_section();
		...
		$ib->add_control( 'block_text_color', [ 'label' => __( 'Text Color', 'jellopoint-restaurant-menu' ), 'type' => Controls_Manager::COLOR, 'selectors' => [ '{{WRAPPER}} {{CURRENT_ITEM}}.jprm-infoblock .jprm-infoblock__content' => 'color: {{VALUE}};' ] ] );
		$ib->add_control( 'block_bg_color', [ 'label' => __( 'Background Color', 'jellopoint-restaurant-menu' ), 'type' => Controls_Manager::COLOR, 'selectors' => [ '{{WRAPPER}} {{CURRENT_ITEM}}.jprm-infoblock' => 'background-color: {{VALUE}};' ] ] );
		$ib->add_control( 'block_alignment', [ 'label' => __( 'Alignment', 'jellopoint-restaurant-menu' ), 'type' => Controls_Manager::CHOOSE, 'options' => [ 'left' => [ 'title' => __( 'Left', 'jellopoint-restaurant-menu' ), 'icon' => 'eicon-text-align-left' ], 'center' => [ 'title' => __( 'Center', 'jellopoint-restaurant-menu' ), 'icon' => 'eicon-text-align-center' ], 'right' => [ 'title' => __( 'Right', 'jellopoint-restaurant-menu' ), 'icon' => 'eicon-text-align-right' ] ], 'selectors' => [ '{{WRAPPER}} {{CURRENT_ITEM}}.jprm-infoblock' => 'text-align: {{VALUE}};' ] ] );
		$ib->add_responsive_control( 'block_font_size', [ 'label' => __( 'Font Size', 'jellopoint-restaurant-menu' ), 'type' => Controls_Manager::SLIDER, 'size_units' => [ 'px', 'em', 'rem' ], 'range' => [ 'px' => [ 'min' => 8, 'max' => 48 ] ], 'selectors' => [ '{{WRAPPER}} {{CURRENT_ITEM}}.jprm-infoblock .jprm-infoblock__content' => 'font-size: {{SIZE}}{{UNIT}};' ] ] );
