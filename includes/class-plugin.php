...
add_action( 'add_meta_boxes', [ $this, 'register_metaboxes' ] );
    ...
    public function ensure_admin_menu() {
        add_menu_page( __( 'JelloPoint Menu', 'jellopoint-restaurant-menu' ), __( 'JelloPoint Menu', 'jellopoint-restaurant-menu' ), 'manage_options', 'jellopoint-root', [ $this, 'render_root' ], 'dashicons-food', 56 );
