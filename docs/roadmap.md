...
| 10C | Automatically show or hide Daily/Weekly Menus according to their date or date range | 🚧 In progress |
...
| Phase | Scope | Status |
| --- | --- | --- |
| 11A | Print/PDF foundation: document settings, paper size, orientation, margins, and reusable data pipeline | ⏳ Planned |
