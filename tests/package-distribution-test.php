...
foreach ( ['free' => false, 'pro' => true] as $edition => $premium ) {
	...
	package_check( false !== strpos( $main, "Version:           2.0.54" ), "$edition plugin version is wrong." );
	package_check( false !== strpos( $main, "define( 'JPRM_VERSION', '2.0.54' )" ), "$edition runtime version is wrong." );
