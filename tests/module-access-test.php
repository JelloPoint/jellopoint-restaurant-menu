...
access_check( Module_Access::allows( 'multiple_prices' ), 'Active Pro Multiple Prices denied.' );
access_check( Module_Access::allows( 'print_pdf' ), 'Active Pro license denied.' );
$entitled = false; access_check( ! Module_Access::allows( 'multiple_prices' ) && ! Module_Access::allows( 'print_pdf' ), 'Unlicensed Pro module allowed.' );
$entitled = true; $build = false; access_check( ! Module_Access::allows( 'multiple_prices' ) && ! Module_Access::allows( 'print_pdf' ), 'Free build contains Pro access.' );
